  ...
  <div v-if="isVisible" class="shortcuts-modal-overlay" @click.self="close">
    <div class="shortcuts-modal-content">
      ...
      <ul>
        ...
        <!-- Για εισαγωγή: ΓΡΑΜΜΑ + "/" : αναζήτηση. ΓΡΑΜΜΑ + ! : πρόσφατο --> 
        <p>Στα πεδία κειμένου:</p>
        <li><strong>ΓΡΑΜΜΑ + /</strong> Αναζήτηση στην Κατηγορία</li>
        <li><strong>ΓΡΑΜΜΑ + !</strong> Πρόσφατες αναζητήσεις της Κατηγορίας</li>
        <p>όπου ΓΡΑΜΜΑ: Δ: δικαιολογητικό, Κ: καλλιέγεια, Π: ποικιλία</p>
      </ul>
...
.shortcuts-modal-content button:hover {
